												...
												<tr style="margin:0;padding:0">
													<td style="margin:0;padding:0">
														...
														<table style="font-family:Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;font-size:10px;font-weight:bold;max-width:50%;border-collapse:collapse;border-spacing:0;width:100%;background-color:transparent;margin:0;padding:0" bgcolor="transparent">
															<tbody>
																<tr style="margin:0;padding:0;height:25px">
																	<td style="margin:0;padding:0;width:15%">USERNAME </td>
														...
														<br/>
														<p style="font-weight:normal;font-size:12px;line-height:1.6;margin:0 0 40px;padding:0">Silahkan <a href="https://client.apadvocates.com" title="Login">Klik disini, </a> untuk mendapatkan perkembangan terbaru kasus anda. </p>
														<p style="font-weight:normal;font-size:12px;padding:0">Best Regards, </p>
														<p style="font-weight:normal;font-size:12px;padding:0">AP Advocates </p>
...
function SendDokumen($email, $username, $category){

		$from = array('office@apadvocates.com' => 'AP Advocates');
		Yii::$app->mailer->compose()
			->setTo($email)
			->setFrom('office@apadvocates.com')
			->setSubject('Dokumen '.$category)
			->setHtmlBody('
				<div bgcolor="#FFFFFF" style="font-family:Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;width:100%!important;min-height:100%;font-size:14px;color:#404040;margin:0;padding:0">
									...
									<div style="max-width:600px;display:block;border-collapse:collapse;margin:0 auto;padding:30px 15px;border:1px solid #e7e7e7">
										<table style="font-family:Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;max-width:100%;border-collapse:collapse;border-spacing:0;width:100%;background-color:transparent;margin:0;padding:0" bgcolor="transparent">
											<tbody>
												<tr style="margin:0;padding:0">
													<td style="margin:0;padding:0">
														<!-- <h4 style="font-family:HelveticaNeue-Light,Helvetica Neue Light,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;line-height:1.1;color:#000;font-weight:500;font-size:23px;margin:0 0 20px;padding:0">AP Advocates</h4> -->
														<p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Dear '.$username.',</p>
														<p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Kami telah mengirimkan dokumen '.$category.' kepada anda.</p>
														
														<p style="font-weight:normal;font-size:12px;line-height:1.6;margin:0 0 40px;padding:0">Silahkan <a href="https://client.apadvocates.com" title="Login">Klik disini, </a> untuk melihat dokumen yang telah kami kirimkan. </p>
														<p style="font-weight:normal;font-size:12px;padding:0">Best Regards, </p>
														<p style="font-weight:normal;font-size:12px;padding:0">AP Advocates </p>
														<div style="text-align:center;margin:20px;padding:0" align="center">														
														</div>
...
function SendConfirmation($email, $username, $status){
											...
											<tbody>
												<tr style="margin:0;padding:0">
													<td style="margin:0;padding:0">
														<!-- <h4 style="font-family:HelveticaNeue-Light,Helvetica Neue Light,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;line-height:1.1;color:#000;font-weight:500;font-size:23px;margin:0 0 20px;padding:0">AP Advocates</h4> -->
														<p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Dear '.$username.',</p>
														<p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Status <span style="color:'.$class.'">'.$description.'</span></p>
														
														<p style="font-weight:normal;font-size:12px;line-height:1.6;margin:0 0 40px;padding:0">Silahkan <a href="https://client.apadvocates.com" title="Login">Klik disini, </a> untuk melihat status terbaru pembayaran anda. </p>
														<p style="font-weight:normal;font-size:12px;padding:0">Best Regards, </p>
														<p style="font-weight:normal;font-size:12px;padding:0">AP Advocates </p>
														<div style="text-align:center;margin:20px;padding:0" align="center">														
														</div>
...
function SendProof($email, $username){

	
		Yii::$app->mailer->compose()
			->setTo('office@apadvocates.com')
			->setFrom('office@apadvocates.com')
			->setSubject('Proof Payment')
			->setHtmlBody('
				<div bgcolor="#FFFFFF" style="font-family:Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;width:100%!important;min-height:100%;font-size:14px;color:#404040;margin:0;padding:0">
										...
										<table style="font-family:Helvetica Neue,Helvetica,Helvetica,Arial,sans-serif;max-width:100%;border-collapse:collapse;border-spacing:0;width:100%;background-color:transparent;margin:0;padding:0" bgcolor="transparent">
											<tbody>
												<tr style="margin:0;padding:0">
													<td style="margin:0;padding:0">
														<!-- <h4 style="font-family:HelveticaNeue-Light,Helvetica Neue Light,Helvetica Neue,Helvetica,Arial,Lucida Grande,sans-serif;line-height:1.1;color:#000;font-weight:500;font-size:23px;margin:0 0 20px;padding:0">AP Advocates</h4> -->
														<p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Dear Finance AP Advocates,</p>
														<p style="font-weight:normal;font-size:14px;line-height:1.6;margin:0 0 20px;padding:0">Klien '.$username.' Telah mengirimkan bukti transfer kepada anda, </p>
														
														<p style="font-weight:normal;font-size:12px;line-height:1.6;margin:0 0 40px;padding:0">Silahkan <a href="https://client.apadvocates.com/admin" title="Login">Klik disini, </a> untuk update status terbaru pembayaran klien. </p>
														<p style="font-weight:normal;font-size:12px;padding:0">Best Regards, </p>
														<p style="font-weight:normal;font-size:12px;padding:0">AP Advocates </p>
														<div style="text-align:center;margin:20px;padding:0" align="center">														
														</div>
